...
public enum ExceptionEnum {
     ...
     */
    public static com.github.eiriksgata.trpg.dice.exception.ExceptionEnum getExceptionEnumByCode(Integer errCode) {
        for (com.github.eiriksgata.trpg.dice.exception.ExceptionEnum exceptionEnum : com.github.eiriksgata.trpg.dice.exception.ExceptionEnum.values()) {
