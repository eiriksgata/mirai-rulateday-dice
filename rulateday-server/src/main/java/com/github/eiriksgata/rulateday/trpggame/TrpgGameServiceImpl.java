...
import com.github.eiriksgata.rulateday.trpggame.utils.DetectionUtil;
...
public class TrpgGameServiceImpl {
    ...
    public static String getAllTrpgModelFiles() {
        File file = new File("data/com.github.eiriksgata.rulateday-dice/trpg-game");
    ...
    public static String loadScriptData(Long id, String fileName) {
        String jsonText = FileUtil.readJsonFile("data/com.github.eiriksgata.rulateday-dice/trpg-game/" + fileName);
        if (jsonText == null) {
